...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(45, 509);
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(462, 509);
			...
			this->button3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button3->Location = System::Drawing::Point(904, 509);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(215, 54);
			...
			this->label1->Location = System::Drawing::Point(41, 412);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(107, 20);
			this->label1->TabIndex = 3;
			this->label1->Text = L"Difficulties:";
			// 
			// label2
			// 
			...
			this->label2->Location = System::Drawing::Point(492, 93);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(93, 20);
			this->label2->TabIndex = 4;
			this->label2->Text = L"QUIZ APP";
			// 
			// DashBoard
			// 
			...
			this->ClientSize = System::Drawing::Size(1191, 605);
